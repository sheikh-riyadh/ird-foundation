...
export default function LoseFat() {
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 mx-5 lg:mx-24 gap-20 justify-center items-center my-24">
            <div>
                <Image alt="Banner_image" className="lg:-ml-10" src={'/assets/lose-fat-image.png'} width={800} height={600}></Image>
            </div>
            <div>
                <h1 className="text-3xl lg:text-6xl leading-snug">Daily morning workout in home</h1>
